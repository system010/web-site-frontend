            ...
            <div className='container '>
                <div class="row ">
                    <div class="col-md-4">
                        ...
                        <li>
                            <a title="Home " itemprop="url ">
                                <span itemprop="name "><i class="fa fa-phone "></i> Phone : +2 01007243297 </span>
                                </a>
                        </li>
                        <li>
                            <a title="Home " itemprop="url "><span itemprop="name "><i class="fa fa-mobile "></i>  Mobile : +2 01004563097</span>
                        </a>
                        </li>
